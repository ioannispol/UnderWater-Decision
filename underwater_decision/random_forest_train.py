...
def get_args():
    ...
    parser.add_argument("--model_file", type=str, default="random_forest_model.pkl",
                        help="Filename to save the trained model.")
    parser.add_argument("--performance_file", type=str, default="random_forest_performance.txt",
...
if __name__ == "__main__":
    ...
    if args.select_all:
        ...
        feature_columns = ['platform', 'year', 'depthmin', 'depthmax', 'item',
